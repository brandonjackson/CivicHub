		...
		<div id="respond">
			...
			<div class="comment-content">
				...
				<h3 id="reply" class="comments-header">
					<?php comment_form_title( __( 'Leave a Comment', 'buddypress' ), __( 'Leave a Reply to %s', 'buddypress' ), true ); ?>
				</h3>

				<p id="cancel-comment-reply">
					<?php cancel_comment_reply_link( __( 'Click here to cancel your comment.', 'buddypress' ) ); ?>
				</p>
