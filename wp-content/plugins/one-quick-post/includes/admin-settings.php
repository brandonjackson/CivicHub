	...
	<div class="wrap">
		...
		<p>
			...
			<ul>
				...
				<li><strong>taxonomies</strong> - <?php _e('If you want to use OQP with custom taxonomies, set them here.','oqp');?> <?php printf(__('Default is %s.','oqp'),'<em>category&post_tag</em>');?> <code>[oqp_form taxonomies='post_tag,yclad_category']</code>
			</ul>
		</p>
		<p>
			...
			<ul>
				...
				<li><strong>taxonomies args</strong> - <?php _e('You can add arguments (between brackets) to the taxonomies you set. Eg. if you want to exclude some categories, use this :','oqp');?><br/>
				<?php _e('eg.','oqp');?> : <code>[oqp_form taxonomies='post_tag,yclad_category' taxonomies{yclad_category}{required}=true]</code><br/>
				<?php _e('eg.','oqp');?> : <code>[oqp_form taxonomies='category' taxonomies{category}{exclude}='10,11']</code>
				<p>
				<?php printf(__("This is quite flexible, but you may have to search a little to find how to do what you want.  Check function %s to get the full list of arguments.",'oqp'),'<strong>oqp_terms_list</strong>');?>
				</p>
				</li>
			</ul>
