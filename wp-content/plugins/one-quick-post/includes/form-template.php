...
function oqp_switch_blog_form() {
	...
	if ((!$oqp_form->args['$blog_select']) || ($oqp_form->post)) {//disabled blog selection if forbidden or if editing a post
		return false;
	}

	$blogs = oqp_get_blogs_of_user($oqp_form->user_id);		
