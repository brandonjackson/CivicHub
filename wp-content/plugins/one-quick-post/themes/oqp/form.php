...
<div id="oqp_post_<?php echo $oqp_form->post->ID;?>" class="oqp_block" rel="<?php echo $oqp_form->post->ID;?>">
	<?php do_action( 'template_notices' ) ?>
	<form id="oqp_form_<?php echo $oqp_form->args['form_id'];?>" class="standard-form oqp-form" method="post" name="oqp_form_<?php echo $oqp_form->args['form_id'];?>">
		...
		<?php if ($oqp_form->is_guest) {?>
			<p>
				...
				<input type="text" name="oqp_dummy_name" id="oqp_dummy_name" value="<?php echo oqp_post_get_guest_name($oqp_form->post->ID);?>"/>
			</p>
			<p>
				<label for="oqp_dummy_email"><?php _e('Email');?></label>
				<input type="text" name="oqp_dummy_email" id="oqp_dummy_email" value="<?php echo oqp_post_get_guest_email($oqp_form->post->ID);?>"/>
			</p>
		<?php } ?>
