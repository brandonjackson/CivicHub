...
Tested up to: 3.0
Stable tag: 3.1.10
Donate link: http://www.kickstarter.com/projects/kirill-novitchenko/tweet-blender-the-awesome-twitter-widget-for-all
...
Version 3.0.0 includes a new widget that *automatically shows tweets relevant to your blog post* by taking post's tags and using them as keywords for Twitter search.
