...
define( 'GPRESS_LANG_DIR', GPRESS_DIR . '\gpress-lang\\'.$gpress_custom_lang_file.'.mo' );
if(file_exists(GPRESS_LANG_DIR)) {
...
if($gpress_bp) {
	...
	$tppo->add_sub_tab(5, 2, __('BuddyPress Styling', 'gpress'), $bp_styling_intro);
}else{
	$tppo->add_sub_tab(5, 1, __('BP Components', 'gpress'), $bpcomp_intro, false);
	$tppo->add_sub_tab(5, 2, __('BuddyPress Styling', 'gpress'), $bp_styling_intro, false);
}
