...
function remove_meta_boxes() {
	...
	remove_meta_box( 'postexcerpt' , $places_taxonomy , 'normal' ); 
	remove_meta_box( 'trackbacksdiv' , $places_taxonomy , 'normal' ); 
	remove_meta_box( 'postcustom' , $places_taxonomy , 'normal' );  
}
...
function gpress_meta_normal_posts_content() {
	...
	if(!empty($geo_latitude)) {
		...
		$force_geopost = $tppo->get_tppo('force_geopost', 'blogs');
