<div class="checkbox">
	...
	<label>
		<input type="checkbox" value="1" id="groupwiki-enable-wiki" name="groupwiki-enable-wiki" onclick="jQuery('#wiki-create-fields, #wiki-create-fields-instructions').toggleClass('wiki-hidden');"/> <?php _e( 'Enable group wiki', 'bp-wiki' ); ?>
	</label>	
...
<p id="wiki-create-fields-instructions"><?php _e( 'Wiki creation options will be displayed once you have ticked to enable the group wiki.', 'bp-wiki' ); ?></p>

<div id="wiki-create-fields" class="wiki-hidden">


	<h3><?php _e( 'Wiki Group Homepage Text', 'bp-wiki' ); ?></h3>
	...
	<textarea id="wiki-homepage-summary" name="wiki-homepage-summary" maxlength="350"><?php _e( 'This is the homepage for your group wiki.  The below table contains links to the indivdual pages available to you.' ); ?></textarea>

	<h3><?php _e( 'Default Page Privacy', 'bp-wiki' ); ?></h3>

	<p><?php _e( 'Please select the default privacy levels for your wiki pages.  These are separate to your group privacy settings and you can later apply settings to individual pages through the group admin menu.', 'bp-wiki' ); ?></p>
	...
	<strong><?php _e( 'All Members', 'bp-wiki' ); ?></strong>
	
	<?php _e( ' - All members of the group can edit wiki pages.', 'bp-wiki' ); ?><br/>


	<input type="radio" name="wiki-edit-rights" value="moderator-only" />


	<strong><?php _e( 'Moderators', 'bp-wiki' ); ?></strong>
	
	<?php _e( ' - Only group moderators (and admins) can edit wiki pages .', 'bp-wiki' ); ?><br/>
	
	<input type="radio" name="wiki-edit-rights" value="admin-only" />
	
	<strong><?php _e( 'Administrators', 'bp-wiki' ); ?></strong>
	<?php _e( ' - Only group admins can edit wiki pages.', 'bp-wiki' ); ?><br/>


	<br/> 

	<h3><?php _e( 'Initial Page Creation', 'bp-wiki' ); ?></h3>	
	...
	<ol id="wiki-page-titles">
		...
		<li class="wiki-page-title-input">
			...
			<input type="textarea" id="wiki-page-title[]" name="wiki-page-title[]" class="wiki-page-title-input" value=""/> 
