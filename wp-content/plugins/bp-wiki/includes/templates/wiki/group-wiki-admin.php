		...
		foreach ( $group_wiki_page_ids_array as $key => $group_wiki_page_id ) {
			...
			<ul id="wiki-page-item-<?php echo $wiki_page->ID; ?>" class="wiki-group-admin-list-page">
				...
				<li class="wiki-page-commenting wiki-group-admin-check-box">
					...
					<input type="checkbox" value="yes" id="wiki-page-comments-on[]" name="wiki-page-comments-on[]"
				...
				<li class="wiki-page-enabled wiki-group-admin-check-box">
					...
					<input 	type="checkbox" value="yes" id="wiki-page-visible[]" name="wiki-page-visible[]"
